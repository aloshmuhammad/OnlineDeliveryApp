...
const getDrivers = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      throw new Error(
        "Error occured during Fetching the Drivers From database"
      );
    }
  });
};
const driverUpdate = async (id, updatedData) => {
  return new Promise(async (resolve, reject) => {
    try {
      const Data = await Driver.findByIdAndUpdate(id, updatedData, {
        new: true,
      });
      if (Data) {
        resolve(Data);
...
const vendorUpdate = async (id, updatedData) => {
  return new Promise(async (resolve, reject) => {
    try {
      const Data = await Vendor.findByIdAndUpdate(id, updatedData, {
        new: true,
      });
      if (Data) {
        resolve(Data);
...
const productList = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      throw new Error(
        "Error occured during geting the products from the database"
      );
    }
  });
};
const productUpdate = async (id, updatedData) => {
  return new Promise(async (resolve, reject) => {
    try {
      const Data = await Products.findByIdAndUpdate(id, updatedData, {
        new: true,
      });
